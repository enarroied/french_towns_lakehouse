...
async def run(config: dict, run_id: str) -> bool:
    """Scrape Petites Cités de Caractère and stage via the shared pipeline.

    Scrapes the sitemap and city pages, writes output to a temporary CSV,
    ...
    return stage_scraper_output(scraper, run_id, cities, FIELDNAMES, EXTENSION)
