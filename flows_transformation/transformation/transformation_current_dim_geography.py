...
MODEL_SELECTOR = "dim_communes dim_geography dim_neighbour_communes dim_zip_codes bridge_communes_zip_codes"


INPUT_SOURCES = ["french_communes", "cog_ensemble", "zip_codes"]
