...
MODEL_SELECTOR = "fact_unemployment"
...
@flow(name="transformation_current_fact_unemployment")
def transformation_current_fact_unemployment() -> None:
    preflight()
    run_id = init_run(
