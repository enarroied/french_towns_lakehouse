...
@flow(name="integration_current_fact_income")
def integration_current_fact_income() -> None:
    preflight()
    run_id = init_run(domain="income", layer="INTEGRATION", technical_type="ICEBERG")
...
if __name__ == "__main__":
    integration_current_fact_income()
